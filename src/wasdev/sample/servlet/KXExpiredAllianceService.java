 ...
 */
@WebServlet("/ExpiredAllianceService")
public class KXExpiredAllianceService extends HttpServlet {
	...
	String sharePointURL="https://ts.accenture.com/sites/AlliancesWizard/myAlliance/_vti_bin//ListData.svc/ExpiredAlliances";   
   @Override
