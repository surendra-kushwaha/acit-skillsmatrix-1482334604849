 ...
 */
@WebServlet("/TEPRSLeadService")
public class KXTEPRSLeadService extends HttpServlet {
	...
	String sharePointURL="https://ts.accenture.com/sites/AlliancesWizard/myAlliance/_vti_bin//ListData.svc/ActiveAlliances";
   ...
   @Override
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			id="6";
			String sharePointTEPUrl=sharePointURL+"("+id+")"+"/TEPRelationshipLead";
			Io = HttpClient.get(sharePointTEPUrl);
